    ...
    axios.post('/login',data)
      .then((response)=>{
        ...
        .then((profileResponse) => {
          ...
          if (profileResponse.data.role !== 'patient') {
            setMessage(`يجب تسجيل الدخول من صفحة ${profileResponse.data.role === 'clinic' ? 'العيادة' : profileResponse.data.role === 'doctor' ? 'الطبيب' : profileResponse.data.role === 'lab' ? 'المختبر' : profileResponse.data.role}`);
            setLoading(false);
            return;
          }
