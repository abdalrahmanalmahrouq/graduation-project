            ...
            <div class="p-6">
                <div class="max-w-2xl mx-auto">
                    <div class="bg-white rounded-lg shadow-sm">
                        ...
                        <!-- Form -->
                        <form action="{{ route('admin.insurances.update',$insurance->insurance_id) }}" method="POST" class="p-6" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            @if($insurance->logo_url)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ $insurance->logo_url }}" alt="Insurance Logo" class="h-16 w-16 object-cover rounded border">
                                </div>
                            @endif
                            ...
                            <div class="mb-6">
                                ...
                                <p class="mt-2 text-xs text-gray-500">Leave empty to keep current. Max 2 MB.</p>
                                @error('logo')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
