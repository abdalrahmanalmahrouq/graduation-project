                ...
                <div class="max-w-2xl mx-auto">
                    <div class="bg-white rounded-lg shadow-sm">
                        ...
                        <div class="p-6 border-b border-gray-200">
                            <h1 class="text-2xl font-semibold text-gray-900">Add New Insurance Company</h1>
                            <p class="text-sm text-gray-600 mt-1">Enter the insurance company details</p>
                        </div>

                        <!-- Form -->
                        <form action="{{ route('admin.insurances.store') }}" method="POST" class="p-6" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-6">
                                ...
                                <p class="mt-2 text-xs text-gray-500">Recommended: square image, max 2 MB.</p>
                                @error('logo')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
