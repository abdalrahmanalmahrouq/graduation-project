                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                                ...
                                                @elseif($user['role'] === 'patient') bg-green-100 text-green-800
                                                @elseif($user['role'] === 'clinic') bg-purple-100 text-purple-800
                        ...
                        <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                            <div class="flex items-center justify-between">
                                <div class="flex-1 flex justify-between sm:hidden">
                                    ...
                                    @else
                                        <a href="{{ $allUsers->previousPageUrl() }}" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                            Previous
                                        </a>
                                    @endif

                                    @if ($allUsers->hasMorePages())
                                        <a href="{{ $allUsers->nextPageUrl() }}" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                            Next
                                        </a>
                                    @else
                                ...
                                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                    <div>
                                        <p class="text-sm text-gray-700">
                                            Showing
                                            <span class="font-medium">{{ $allUsers->firstItem() }}</span>
                                            to
                                            <span class="font-medium">{{ $allUsers->lastItem() }}</span>
                                            of
                                            <span class="font-medium">{{ $allUsers->total() }}</span>
                                            results
                                        </p>
                                    </div>
                                    <div>
                ...
                <div class="mt-4 text-center">
                    ...
                    <div class="mt-2 px-4 py-3">
                        <p class="text-sm text-gray-500">
                            Are you sure you want to delete <span id="userName" class="font-semibold text-gray-700"></span>?
                        </p>
