...
class AppointmentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $bookings = [
            ...
            ['patient_email' => 'bilal69@example.com',      'date' => Carbon::now()->addDays(33)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'ahmed@example.com',    'date' => Carbon::now()->addDays(34)->format('Y-m-d'), 'status' => 'cancelled'],
            ['patient_email' => 'sara81@example.com',    'date' => Carbon::now()->addDays(2)->format('Y-m-d'),  'status' => 'booked'],
            ['patient_email' => 'yousef44@example.com',  'date' => Carbon::now()->addDays(36)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'nada33@example.com',    'date' => Carbon::now()->addDays(37)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'majdi27@example.com',   'date' => Carbon::now()->addDays(38)->format('Y-m-d'), 'status' => 'no-show'],
            ['patient_email' => 'farida66@example.com',  'date' => Carbon::now()->addDays(39)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'ammar95@example.com',   'date' => Carbon::now()->addDays(40)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'reem58@example.com',    'date' => Carbon::now()->addDays(41)->format('Y-m-d'), 'status' => 'cancelled'],
            ['patient_email' => 'tareq71@example.com',   'date' => Carbon::now()->addDays(42)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'hala54@example.com',    'date' => Carbon::now()->addDays(43)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'mohammed42@example.com','date' => Carbon::now()->addDays(44)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'jasmine22@example.com', 'date' => Carbon::now()->addDays(45)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'bilal69@example.com',   'date' => Carbon::now()->addDays(46)->format('Y-m-d'), 'status' => 'no-show'],
            ['patient_email' => 'khalid@example.com',     'date' => Carbon::now()->addDays(47)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'mohsen@example.com',     'date' => Carbon::now()->addDays(48)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'ahmed@example.com',      'date' => Carbon::now()->addDays(49)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'sara81@example.com',    'date' => Carbon::now()->addDays(50)->format('Y-m-d'), 'status' => 'cancelled'],
            ['patient_email' => 'yousef44@example.com',  'date' => Carbon::now()->addDays(51)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'nada33@example.com',    'date' => Carbon::now()->addDays(52)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'majdi27@example.com',   'date' => Carbon::now()->addDays(53)->format('Y-m-d'), 'status' => 'no-show'],
            ['patient_email' => 'farida66@example.com',  'date' => Carbon::now()->addDays(54)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'ammar95@example.com',   'date' => Carbon::now()->addDays(55)->format('Y-m-d'), 'status' => 'booked'],
            ['patient_email' => 'reem58@example.com',    'date' => Carbon::now()->addDays(56)->format('Y-m-d'), 'status' => 'cancelled'],
            // ['patient_email' => 'mohsen@example.com',     'date' => Carbon::now()->addDays(32)->format('Y-m-d'), 'status' => 'booked'],
            // ['patient_email' => 'bilal69@example.com',      'date' => Carbon::now()->addDays(33)->format('Y-m-d'), 'status' => 'booked'],
            // ['patient_email' => 'ahmed@example.com',    'date' => Carbon::now()->addDays(34)->format('Y-m-d'), 'status' => 'cancelled'],
