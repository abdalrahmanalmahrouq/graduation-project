            ...
            switch ($user->email) {
                ...
                case 'majid39@example.com':
                    $doctorData = [
                        ...
                        'specialty' => 'اخصائي انف اذن و حنجرة',
