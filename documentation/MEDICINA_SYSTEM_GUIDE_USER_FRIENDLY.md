# Medicina Healthcare System - User Guide

## Welcome to Medicina

**Medicina** is a modern healthcare management platform designed to make healthcare in Jordan easier, faster, and more connected. Whether you're a patient looking for a doctor, a doctor managing appointments, a clinic organizing operations, or a lab sharing test results, Medicina brings everyone together in one simple, secure system.

---

## Table of Contents

1. [What is Medicina?](#what-is-medicina)
2. [Who Uses Medicina?](#who-uses-medicina)
3. [Getting Started](#getting-started)
4. [Features for Each User Type](#features-for-each-user-type)
...
Medicina is like a digital bridge that connects everyone in the healthcare system:

- **Patients** can find doctors, book appointments, view their medical records, and receive lab results
- **Doctors** can manage their schedules, see patients, and create medical records
- **Clinics** can organize their doctors, manage appointments, and track their business
- **Labs** can securely share test results with patients
- **Administrators** can manage the system and insurance companies

Think of it as a smart assistant that helps everyone in healthcare work together more efficiently.

### Key Benefits

✅ **Save Time** - Book appointments online without phone calls  
...
- Link lab results to patient records
...
- Manage which insurance companies they accept
...
3. Choose a password
4. Select your insurance company (if you have one)
...
3. Choose a password
4. Upload a clinic logo (optional)
5. Click "Register"
...
3. Choose a password
4. Upload a lab logo (optional)
5. Click "Register"
6. You can now start sharing results with patients!

### Logging In

1. Go to the login page for your role (patient, doctor, clinic, or lab)
2. Enter your email and password
3. Make sure you're on the correct login page for your role
4. Click "Login"
5. You'll be taken to your personal dashboard

**Important:** If you try to log in from the wrong page (for example, a doctor trying to log in from the patient page), the system will tell you which page you should use instead.
...
- Book instantly (you'll need to be logged in)
...
- See which doctor and clinic each record is from
...
- Related lab test results (if linked)
...
- View all your approved lab results
- Download result files (PDFs or images)
...
- Doctors can only see results you've approved
...
- Manage your availability at each clinic independently
...
- Link approved lab results to the record (optional)
...
- Create appointment slots for each doctor
...
- Delete slots if needed (before they're booked)
...
- Track number of insurance companies accepted
- View top 5 insurance companies used
...
- Optionally link results to specific appointments
...
- View which are rejected (patient declined)
- Track uploaded results
...
- Can link any approved lab results
- Patient can immediately view the record
...
4. Sees list of cardiologists
5. Clicks on a doctor to see their profile and clinics
6. Selects a clinic that accepts their insurance
7. Views available appointment times
8. Books an appointment for next week
9. Receives confirmation
10. On appointment day, goes to clinic
11. After visit, doctor creates medical record
12. Patient can view the record in their account

**Time Saved:** No phone calls, no waiting on hold, instant booking!
...
4. Clinic B creates different appointment slots
5. Doctor logs in and sees both clinics
6. Can view appointments at Clinic A separately from Clinic B
7. Can also view all appointments together
8. When completing an appointment, selects which clinic it was at
9. Medical records are linked to the correct clinic

**Benefit:** Doctors can easily manage multiple locations!
...
5. Patient approves the request
6. Lab uploads the test results (PDF file)
7. Patient can immediately view and download results
8. If patient sees a doctor, doctor can link these results to medical record
9. Complete health picture is created

**Privacy:** Patient controls who sees their results!
...
A: You can browse doctors and view available slots without an account, but you'll need to log in (or create an account) when you actually book an appointment.

**Q: Can I cancel an appointment?**  
A: Yes, you can cancel appointments from your "Upcoming Appointments" page. Some clinics may have cancellation policies.

**Q: How do I know if a clinic accepts my insurance?**  
A: When viewing a doctor's profile, you'll see which clinics they work at and which insurance companies each clinic accepts. You can also filter doctors by insurance when searching.

**Q: Can I see my old medical records?**  
A: Yes! All your medical records are stored in your account. Go to "Medical Records" to see your complete history.

**Q: What if I reject a lab result request?**  
A: If you reject a request, the lab cannot upload results. You can always approve a new request later if you change your mind.

**Q: How do I update my information?**  
A: Go to "Account Settings" from your dashboard. You can update your personal information, insurance, and password there.

---

### For Doctors

**Q: Can I work at multiple clinics?**  
A: Yes! Medicina supports doctors working at multiple clinics. Each clinic manages your schedule independently.

**Q: How do I create a medical record?**  
A: After completing an appointment, mark it as "completed." Then you'll see an option to "Create Medical Record" for that appointment.
...
**Q: How do I add a doctor to my clinic?**  
A: Go to "Manage Doctors" and search for the doctor. Once you find them, click "Add Doctor" and set up their schedule.

**Q: How do I create appointment slots?**  
A: After adding a doctor, you can create appointment slots by selecting dates and times when the doctor is available.

**Q: Can I remove a doctor and add them back later?**  
A: Yes! If you remove a doctor, the relationship is saved (soft-deleted). You can restore them later without losing any data.

**Q: How do I add insurance companies?**  
A: Go to "Insurance Management" and select which insurance companies your clinic accepts. This helps patients find you.

**Q: What statistics can I see?**  
A: Your dashboard shows number of doctors, patients, appointments, and insurance companies. You can also see top insurances and top patients.

---

### For Labs

**Q: Why do I need patient approval to share results?**  
A: Patient privacy is important! Patients must approve before you can upload results. This protects their privacy and gives them control.

**Q: What happens if a patient rejects my request?**  
A: If rejected, you cannot upload results for that request. You can create a new request later if needed.

**Q: Can I link results to appointments?**  
A: Yes! When uploading results, you can optionally link them to a specific appointment. This helps create a complete medical picture.

**Q: What file types can I upload?**  
A: You can upload PDF files or image files (like JPG, PNG) containing the test results.

**Q: How do I track my requests?**  
A: In your "Lab Results" page, you can see all requests with their status: pending (waiting for approval), approved (ready to upload), rejected (patient declined), or uploaded (completed).
...
✅ **Keep Your Profile Updated** - Make sure your insurance and contact information are current so clinics can reach you and you can find the right doctors.

✅ **Check Notifications Regularly** - Lab results and other important updates come through notifications. Check them often!

✅ **Review Medical Records** - After each appointment, review your medical record to stay informed about your health.

✅ **Book in Advance** - Popular doctors fill up quickly. Book appointments ahead of time to get your preferred time slot.

✅ **Use Insurance Filters** - Filter by your insurance company to find clinics that accept it and avoid surprises.

---

### For Doctors

✅ **Complete Medical Records Promptly** - Create medical records soon after appointments while details are fresh in your mind.

✅ **Link Relevant Lab Results** - When creating records, link any relevant lab results to give patients a complete picture.

✅ **Keep Your Bio Updated** - A good bio helps patients understand your expertise and choose you.

✅ **Manage Schedules Carefully** - Work with clinics to ensure your schedule is accurate and up-to-date.

✅ **Review Patient History** - Before appointments, review patient's medical records and lab results for context.

---

### For Clinics

✅ **Keep Doctor Schedules Updated** - Regularly update appointment slots to reflect actual availability and avoid double-bookings.

✅ **Manage Insurance List** - Keep your accepted insurance companies current so patients can find you.

✅ **Monitor Your Dashboard** - Check statistics regularly to understand your clinic's performance and make data-driven decisions.

✅ **Add Doctors Proactively** - Add doctors and set up their schedules before they start to ensure smooth operations.

✅ **Review Appointments Daily** - Check upcoming appointments to prepare for the day and ensure everything is organized.

---

### For Labs

✅ **Request Permission Early** - Create result requests as soon as tests are complete so patients can approve and you can upload promptly.

✅ **Provide Clear Information** - When creating requests, include clear examination titles so patients understand what they're approving.

✅ **Upload Promptly After Approval** - Once a patient approves, upload results quickly so they have access to their information.

✅ **Use Descriptive Titles** - Clear examination titles help patients and doctors understand what each test is for.

✅ **Link to Appointments When Relevant** - If results are related to a specific appointment, link them so doctors can see the connection.
...
🔒 **Secure Login** - Your password is encrypted and never stored in plain text. Only you know your password.

🔒 **Role-Based Access** - Each user type can only access features relevant to their role. Patients can't see doctor features, and vice versa.

🔒 **Patient Privacy** - Lab results require patient approval before sharing. Patients control who sees their medical information.

🔒 **Account Recovery** - If you accidentally delete your account, it can be restored. Your data is never permanently lost immediately.

🔒 **Secure File Storage** - All uploaded files (profile images, lab results) are stored securely and only accessible to authorized users.
...
- **Account Issues** - Contact system administrators if you have trouble logging in or accessing your account
- **Technical Problems** - Report any bugs or technical issues to the support team
- **Questions About Features** - Refer to this guide or contact support for clarification
- **Privacy Concerns** - If you have concerns about data privacy, contact the system administrators
...
Welcome to Medicina - where healthcare meets technology for a better experience for everyone!
